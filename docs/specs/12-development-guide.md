...
ローカル開発では Google AI Studio で発行した API キーを使用する。
ADC（Application Default Credentials）や Vertex AI は使用しない。
...
| GEMINI_API_KEY | Yes | Google AI Studio API キー | `AIza...` |
