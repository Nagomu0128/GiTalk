...
export function ConversationCard({ id, title, updatedAt, description, onDelete, onSave }: ConversationCardProps) {
  ...
  return (
    <>
      <div className="relative rounded-xl border border-neutral-200 bg-white p-5 shadow-md transition-shadow hover:shadow-lg dark:border-transparent dark:bg-neutral-800 dark:shadow-none dark:hover:bg-neutral-750">
        <button
