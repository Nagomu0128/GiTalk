...
export const AppSidebar = ({
  ...
  return (
    <>
      <aside
        className={`flex h-full shrink-0 flex-col border-r border-neutral-200 bg-white transition-all dark:border-neutral-700 dark:bg-neutral-950 ${
          collapsed ? 'w-20' : 'w-64'
        }`}
      >
        ...
        <nav className="flex flex-1 flex-col gap-1 px-2">
          <button
            onClick={onNewChat}
            className="flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-neutral-600 transition-colors hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800"
          >
        ...
        {user && (
          <div className="border-t border-neutral-200 px-2 py-3 dark:border-neutral-700">
            <Popover>
              <PopoverTrigger
